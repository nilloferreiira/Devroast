    ...
    <CodeBlockRoot>
      <CodeBlockHeader>
        <div className="flex w-full items-center justify-between gap-4">
          <span>
            newCode.
            {effectiveLanguage === "plaintext" ? "txt" : effectiveLanguage}
          </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="inline-flex h-8 min-w-[148px] items-center justify-between gap-2 border border-border-primary bg-bg-elevated px-2.5 font-mono text-[11px] text-text-primary outline-none transition-colors hover:border-border-secondary focus:border-border-secondary"
            >
      ...
      <div className="relative min-h-[280px] bg-bg-surface">
        <pre
          ref={highlightRef}
